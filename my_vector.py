...
class MyVectorParameter(MyGroupParameter):
    ...
    def __init__(self, **opts):
        ...
        self.addChild(dict(name='azimuth', type='myFloat', enabled=False, readonly=True, decimals=d, suffix='deg'))   # set value through setAzimuth()
        self.addChild(dict(name='tilt', type='myFloat', enabled=False, readonly=True))                                               # set value through setTilt()
