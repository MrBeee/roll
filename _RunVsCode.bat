...
@REM start "C:\Program Files\QGIS 3.34.13\OSGeo4W.bat" start cmd.exe /k  _VsCodeScript
start "" "C:\Program Files\QGIS 3.34.13\OSGeo4W.bat" start cmd.exe /k  _VsCodeScript
