...
class MyRollParameter(MyGroupParameter):
    ...
    def __init__(self, **opts):
        ...
        self.addChild(dict(name='azim', type='myFloat', decimals=d, suffix='deg', value=self.row.azim, enabled=False, readonly=True))     # set value through setAzimuth()     # myFloat
        self.addChild(dict(name='tilt', type='myFloat', decimals=d, suffix='deg', value=self.row.tilt, enabled=False, readonly=True))     # set value through setTilt()    # myFloat
...
#         self.decimals = opts.get('decimals', 7)
...
#             self.addChild(dict(name='Source seed', type='bool', value=self.seed.bSource))
#             self.addChild(dict(name='Seed color', type='color', value=self.seed.color))
#             self.addChild(dict(name='Seed origin', type='myPoint3D', value=self.seed.origin, expanded=False, flat=True, decimals=self.decimals))
...
#             self.addChild(dict(name='Seed pattern', type='myList', value=config.patternList[nPattern], default=config.patternList[nPattern], limits=config.patternList))
#             self.addChild(
#                 dict(name='Grid grow steps', type='myRollList', value=self.seed.grid.growList, default=self.seed.grid.growList, expanded=True, flat=True, decimals=self.decimals, suffix='m', brush='#add8e6')
#             )

#             self.addChild(dict(name='Circle grow steps', type='myCircle', value=self.seed.circle, default=self.seed.circle, expanded=True, flat=True, brush='#add8e6'))
#             self.addChild(dict(name='Spiral grow steps', type='mySpiral', value=self.seed.spiral, default=self.seed.spiral, expanded=True, flat=True, brush='#add8e6'))
#             self.addChild(dict(name='Well grow steps', type='myWell', value=self.seed.well, default=self.seed.well, expanded=True, flat=True, brush='#add8e6'))
...
class MyWellParameter(MyGroupParameter):
    ...
    def changedF(self):
        ...
        time = config.elapsedTime(time, 13)
