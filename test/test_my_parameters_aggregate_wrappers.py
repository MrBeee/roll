...
class AggregateParameterWrapperTest(unittest.TestCase):
    ...
    def testConfigurationParameterWritesBackToSurvey(self):
        ...
        parameter.parC.child('CRS').setValue(QgsCoordinateReferenceSystem('EPSG:28992'))
        ...
        self.assertEqual(survey.crs.authid(), 'EPSG:28992')
        self.assertEqual(survey.type.name, 'Marine')
        self.assertEqual(survey.name, 'Renamed-Survey')
        self.assertEqual(values[0].authid(), 'EPSG:28992')
    ...
    def testBlockParameterWritesTemplateListBackToBlock(self):
        ...
        parameter.parS.parXmin.setValue(10.0)
        parameter.parS.parXmax.setValue(30.0)
        parameter.parS.parYmin.setValue(20.0)
        parameter.parS.parYmax.setValue(40.0)
        parameter.parT.templateList = updatedTemplateList
        parameter.changed()
        self.qgisApp.processEvents()

        self.assertEqual(parameter.value().borders.srcBorder, QRectF(10.0, 20.0, 20.0, 20.0))
    ...
    def testTemplateParameterWritesSeedListBackToTemplate(self):
        ...
        parameter.parR.moveList = updatedRollList
        parameter.parS.seedList = updatedSeedList
        parameter.changed()
        self.qgisApp.processEvents()
