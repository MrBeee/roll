...
class MyBlockParameter(MyGroupParameter):
    ...
    def contextMenu(self, name=None):
        ...
        if name == 'remove':
            reply = QMessageBox.question(None, 'Please confirm', 'Delete selected block ?', QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.No)
...
class MyTemplateParameter(MyGroupParameter):
    ...
    def contextMenu(self, name=None):
        ...
        ## name == 'rename' already resolved by self.editName() in MyGroupParameterItem
        if name == 'remove':
            reply = QMessageBox.question(None, 'Please confirm', 'Delete selected template ?', QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.No)
            if reply == QMessageBox.StandardButton.Yes:
                self.remove()
...
class MyPatternSeedListParameter(MyGroupParameter):
    ...
    def contextMenu(self, name=None):
        ...
        QApplication.instance()QApplication.instance().processEvents()
...
class MySeedParameter(MyGroupParameter):
    ...
    def contextMenu(self, name=None):
        ...
        ## name == 'rename' already resolved by self.editName() in MyGroupParameterItem
        if name == 'remove':
            reply = QMessageBox.question(None, 'Please confirm', 'Delete selected seed ?', QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.No)
            if reply == QMessageBox.StandardButton.Yes:
                self.remove()
...
class MyPatternParameter(MyGroupParameter):
    ...
    def contextMenu(self, name=None):
        ...
        ## name == 'rename' already resolved by self.editName() in MyGroupParameterItem
        if name == 'remove':
            reply = QMessageBox.question(None, 'Please confirm', 'Delete selected pattern ?', QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.No)
            if reply == QMessageBox.StandardButton.Yes:
                self.remove()
