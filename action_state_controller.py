...
class ActionStateController:
    ...
    def updateMenuStatus(self, resetAnalysis=True):
        ...
        self._setActionStates(
            ...
            ('actionExportOffsetGaps', window.output.offsetGap is not None),
            ...
            ('actionGapO', window.output.offsetGap is not None),
            ...
            ('btnGapToQGIS', window.output.offsetGap is not None),
            ...
            ('actionExportOffsetGapsToQGIS', window.output.offsetGap is not None),
